...
public class ArticleController {
        ...
        for (Article article : articles) {
            resultHtml
                    ...
                    .append("<td class=\"col-md-3\">"
                            ...
                            + "</td>")
                    .append("<td class=\"col-md-2\">"
                            + article.getCreatedOn().format(DateTimeFormatter.ofPattern("HH:mm dd-MM-yyyy"))
                            + "</td>")
                    .append("<td class=\"col-md-2\">"
                            + article
                            .getAuthor()
    ...
    public String edit(@PathVariable(name = "id") String id, Model model, HttpSoletRequest request) {
        ...
        if (article == null
                ...
                .getAuthor()
                .getId()
                .equals(request.getSession().getAttributes().get("user-id").toString())
                && !request
                .getSession()
                .getAttributes()
                .get("role")
    ...
    public String editConfirm(@PathVariable(name = "id") String id, HttpSoletRequest request,
                              ArticleCreateBindingModel articleCreateBindingModel) {
        if (request.getSession() == null) {
            return "redirect:/login";
        }
